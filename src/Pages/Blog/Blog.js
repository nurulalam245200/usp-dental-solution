      ...
      <div className="collapse">
        ...
        <div className="collapse-content">
          <p>
            ...
            NoSQL is better for unstructured data like documents or JSON. <br />{" "}
            As for speed, NoSQL is generally faster than SQL, especially for
            key-value storage in our experiment; On the other hand, <br /> NoSQL
            database may not fully support ACID transactions, which may result
            data inconsistency.
          </p>
        </div>
      </div>
      <div className="collapse">
        ...
        <div className="collapse-content">
          <p>
            ...
            parties as JSON object. It is compact, <br /> readable and digitally
            signed using a private key/ or a public key pair by the Identity
            Provider(IdP).Information Exchange: <br /> JWTs are a good way of
            securely transmitting information between parties because they can
            be signed, which means you can be sure that the senders are <br />{" "}
            who they say they are. Additionally, the structure of a JWT allows
      ...
      <div className="collapse">
        ...
        <div className="collapse-content">
          <p>
            ...
            any browser that has the JavaScript Engine installed.It is basically
            used on the client-side. <br /> Node. js, on the other hand, is an
            interpreter or execution environment for the JavaScript programming
            language.It is mostly used on the server-side. <br /> Nodejs allows
            Javascript code to run outside the browser. Nodejs comes with a lot
            of modules and mostly used in web development. <br /> Javascript is
      ...
      <div className="collapse">
        ...
        <div className="collapse-content">
          <p>
            ...
            process the request without I/O blocking <br /> then the event loop
            would itself process the request and sends the response back to the
            client by itself. But, <br />
